      ...
      <View style={cartitemstyle.promoContainer}>
        {appliedPromoCode ? (
          <View style={cartitemstyle.appliedPromoContainer}>
            ...
            >
              <Text style={cartitemstyle.removePromoButtonText}>
                {strings.cross}
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={cartitemstyle.promoInputContainer}>
            <TextInput
              style={[cartitemstyle.promoInput, { color: colors.colors.text }]}
            ...
            >
              <Text style={cartitemstyle.applyButtonText}>{strings.apply}</Text>
            </TouchableOpacity>
          </View>
        )}
      </View>
